        ...
        <div className="w-full">
            <div className="flex items-center justify-between mb-8">
                ...
                <select
                    ...
                    className="px-3 py-1.5 text-[10px] font-black uppercase border border-gray-100 dark:border-gray-800 rounded-xl bg-gray-50 dark:bg-gray-900/50 text-gray-500 dark:text-gray-400 focus:ring-2 focus:ring-emerald-500 outline-none transition-all"
                >
                                ...
                                <div
                                    ...
                                    style={{
                                        ...
                                        background: isHovered
                                            ? `linear-gradient(to top, ${colors.emerald[600]}, ${colors.emerald[400]})`
                                            : `linear-gradient(to top, ${colors.emerald[500]}, ${colors.emerald[300]})`
                                    }}
                                >
